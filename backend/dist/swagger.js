    ...
    paths: {
        "/api/jupiter/order": {
            get: {
                ...
                description: "Returns a route for swapping from inputMint to outputMint using Jupiter",
                tags: ["Jupiter"],
                parameters: [
                    {
                        name: "inputMint",
        ...
        "/api/wallet/connect": {
            post: {
                ...
                description: "Saves wallet connection data to Supabase for analytics and tracking purposes",
                tags: ["Wallet"],
                requestBody: {
                    required: true,
                    content: {
